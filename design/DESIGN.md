...
| 模块 | 职责 | 详细文档 |
|------|------|----------|
| 用户 (User) | 用户注册、登录、认证、头像与媒体上传 | [DESIGN-USER.md](./DESIGN-USER.md) |
| 用户媒体 (User Media) | 用户照片/视频上传、存储、头像设置，供交友与商品图使用 | [DESIGN-USER.md](./DESIGN-USER.md)（用户媒体一节） |
| 代理 (Agent) | Agent 创建、人设生成、对话、状态管理、关联商品 | [DESIGN-AGENT.md](./DESIGN-AGENT.md) |
| 技能 (Skill) | 内置技能 (全用户) + 用户自定义技能 (PAID)，Prompt 注入与回复校验 | [DESIGN-SKILL.md](./DESIGN-SKILL.md) |
| 用户商店 (UserShop) | 用户个人商品管理、定价、图片、与 Agent 双向绑定，买卖场景下发商品卡片 | [DESIGN-USERSHOP.md](./DESIGN-USERSHOP.md) |
