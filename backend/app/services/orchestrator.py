...
from app.repositories.base import SessionRepository, MessageRepository, AgentRepository, MatcherRepository, MatchResultRepository, ProductRepository
...
async def run_orchestrator(
    ...
    for chat_session in active_sessions:
        # Agent turn (product_repo enables Product Salesman built-in skill)
        await process_turn(session_repo, message_repo, agent_repo, chat_session.id, product_repo=product_repo)
